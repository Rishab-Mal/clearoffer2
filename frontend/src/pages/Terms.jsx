      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <p>You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You agree to notify us immediately of any unauthorized use at <a href="mailto:hello@clearoffer.org" className="text-amber-600 hover:underline">hello@clearoffer.org</a>.</p>
          </section>
          ...
          <section>
            ...
            <p>Questions about these Terms? Email <a href="mailto:hello@clearoffer.org" className="text-amber-600 hover:underline">hello@clearoffer.org</a>.</p>
          </section>
